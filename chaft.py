...
def check_url(url):
    ...
    try:
        ...
        print(f"[-] {url} \t {colored('Connection error. If your Internet connection works fine and URL is accessible in regular communication, URL may be considered as NOT ACCESSIBLE', 'yellow')}")
